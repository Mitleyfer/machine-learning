...
def get_pet_labels(image_dir):
    ...
    results_dic = dict()
    file_names = [i.split("_") for i in in_files]
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           pet_label = ""
           for i in range(len(file_names[idx])):
               if file_names[idx][i].isalpha():
                   pet_label += file_names[idx][i].lower() + " "
